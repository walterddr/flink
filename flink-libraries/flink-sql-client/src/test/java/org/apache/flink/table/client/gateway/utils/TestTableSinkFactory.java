...
import org.apache.flink.table.sinks.TableSinkFactory;
 ...
 */
public class TestTableSinkFactory implements TableSinkFactory<Row> {

	@Override
	public Map<String, String> requiredContext() {
		final Map<String, String> context = new HashMap<>();
		context.put(CONNECTOR_TYPE(), "test-table-sink-factory");
		return context;
	}
	 ...
	 * Test table sink.
	 */
	public static class TestTableSink implements TableSink<Row> {
