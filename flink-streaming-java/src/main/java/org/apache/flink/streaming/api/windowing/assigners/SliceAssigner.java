...
/**
 * A {@code WindowAssigner} assigns zero or one unique {@link Window Windows} to an element.
 *
 * It specifies the type of window that are guaranteed to be non-overlapping.
 *
