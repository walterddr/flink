...
import org.apache.flink.streaming.api.windowing.triggers.ProcessingTimeSameWindowTrigger;
...
public class ProcessingTimeSameWindows extends SameWindowAssigner<Object>{
	...
	public Trigger<Object, VoidWindow> getDefaultTrigger(StreamExecutionEnvironment env) {
		return ProcessingTimeSameWindowTrigger.create();
	}

	@Override
	public String toString() {
		return "ProcessingTimeSameWindows()";
	}

	/**
	 * Creates a new {@code ProcessingTimeSameWindow} {@link WindowAssigner} that assigns
	 * elements to void window.
	 *
	 * @return The time policy.
	 */
	public static ProcessingTimeSameWindows create() {
		return new ProcessingTimeSameWindows();
	}
