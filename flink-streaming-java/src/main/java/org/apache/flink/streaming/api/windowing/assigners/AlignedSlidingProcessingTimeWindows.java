 ...
 * } </pre>
 */
public class AlignedSlidingProcessingTimeWindows extends AlignedWindowAssigner<Object, TimeWindow> {
	...
	private AlignedSlidingProcessingTimeWindows(long size, long slide, long offset) {
	...
	@Override
	public Collection<TimeWindow> assignSlices(Object element, long timestamp, WindowAssignerContext context) {
	 ...
	 */
	public static AlignedSlidingProcessingTimeWindows of(Time size, Time slide) {
		return new AlignedSlidingProcessingTimeWindows(size.toMilliseconds(), slide.toMilliseconds(), 0);
	}
	 ...
	 * @return The time policy.
	 */
	public static AlignedSlidingProcessingTimeWindows of(Time size, Time slide, Time offset) {
		return new AlignedSlidingProcessingTimeWindows(size.toMilliseconds(), slide.toMilliseconds(),
