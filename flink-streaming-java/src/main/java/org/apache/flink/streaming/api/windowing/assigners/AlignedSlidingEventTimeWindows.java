 ...
 */
@PublicEvolving
public class AlignedSlidingEventTimeWindows extends AlignedWindowAssigner<Object, TimeWindow> {
	...
	protected AlignedSlidingEventTimeWindows(long size, long slide, long offset) {
	 ...
	 */
	public static AlignedSlidingEventTimeWindows of(Time size, Time slide) {
		return new AlignedSlidingEventTimeWindows(size.toMilliseconds(), slide.toMilliseconds(), 0);
	}
	 ...
	 * @return The time policy.
	 */
	public static AlignedSlidingEventTimeWindows of(Time size, Time slide, Time offset) {
		return new AlignedSlidingEventTimeWindows(size.toMilliseconds(), slide.toMilliseconds(),
