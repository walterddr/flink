 ...
 */
@PublicEvolving
public class ProcessingTimeSameWindowTrigger extends Trigger<Object, VoidWindow> {
	private static final long serialVersionUID = 1L;

	private ProcessingTimeSameWindowTrigger() {}

	@Override
	public TriggerResult onElement(Object element, long timestamp, VoidWindow window, TriggerContext ctx) throws Exception {
		ctx.registerProcessingTimeTimer(timestamp + 1); // Fire on next millisecond
	...
	public String toString() {
		return "ProcessingTimeSameWindowTrigger()";
	}

	/**
	 * Creates an processing-time same window trigger that fires once the watermark passes
	 * the element time.
	 */
	public static ProcessingTimeSameWindowTrigger create() {
		return new ProcessingTimeSameWindowTrigger();
	}
}
