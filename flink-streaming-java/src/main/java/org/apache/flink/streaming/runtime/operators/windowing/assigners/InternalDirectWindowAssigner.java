 ...
 */
@Internal
public class InternalDirectWindowAssigner<T, W extends Window>
	implements InternalWindowAssigner<T, W>, Serializable {
	private static final long serialVersionUID = 1L;

	private WindowAssigner<T, W> windowAssigner;

	public InternalDirectWindowAssigner(WindowAssigner<T, W> windowAssigner) {
