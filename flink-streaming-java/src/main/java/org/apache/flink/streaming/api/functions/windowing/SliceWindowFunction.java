 ...
 */
public final class SliceWindowFunction<IN, OUT, KEY, W extends Window>
		extends WrappingFunction<WindowFunction<IN, OUT, KEY, W>>
		implements WindowFunction<Slice<IN, KEY, W>, OUT, KEY, W> {

	private static final long serialVersionUID = 1L;

	public SliceWindowFunction(WindowFunction<IN, OUT, KEY, W> wrappedFunction) {
		super(wrappedFunction);
	}

	@Override
	public void apply(KEY key, W window, Iterable<Slice<IN, KEY, W>> input, Collector<OUT> out) throws Exception {
